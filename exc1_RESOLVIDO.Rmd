...
# Obs.: você pode querer coletar mais tuítes modificando o valor de "n".
...
Extra: você pode pensar em outro parâmetro, que a função *searchTwitter()* tenha que possa ser útil para selecionar melhor os tuítes? E usando os parâmetros da API de busca do próprio twitter? (Ou seja, colocando oppões adicionais na busca).
...
hist(pesquisa[pesquisa$favoriteCount > 0, 'favoriteCount'])
...
mean(pesquisa$favoriteCount)
mean(pesquisa[pesquisa$favoriteCount > 0, 'favoriteCount'])
